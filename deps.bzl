...
def go_dependencies():
    ...
    go_repository(
        ...
        sum = "h1:mwOzbdMR7uv2vul9J0FU3GYxE7ls/iX1ieMg5WIM6gE=",
        version = "v1.6.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:0H8s0vumYx/YKs4sE7YM0ktwL2eWse+kfopsRI1sXVI=",
        version = "v1.47.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:lL7IfaFzngfx0ZwUGOZdsFFnQ5uLvR0hWqqhyE7Q9M8=",
        version = "v1.6.7",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:r67ps7oHCYnflpgDy2LZU0MAQtQbYIOqNNnqGO6xQkE=",
        version = "v1.3.25",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:HCpPsWqmYQieU7SS6E9HXfdAMSud0pteVXieJmcpIRI=",
        version = "v1.4.6",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:BbGDtTi0T1DYlmjBiCr/le3wzhA37O8QTC5/Ab8+EXk=",
        version = "v1.18.6",
    )
    go_repository(
        name = "com_github_aws_aws_sdk_go_v2_service_s3",
        importpath = "github.com/aws/aws-sdk-go-v2/service/s3",
        sum = "h1:nyuzXooUNJexRT0Oy0UQY6AhOzxPxhtt4DcBIHyCnmw=",
        version = "v1.71.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:CJyGEyO1CIwOnXTU40urf0mchf6t3voxpvUDikOU9LY=",
        version = "v0.16.2",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:jqq3D9vC9pPq1dGcOCv7yOp1DaEe7c/T1vzcLbITSp4=",
        version = "v0.128.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:1RoU2NS+b98o1L77sdl5mboGPiW+0Ypsi5oLmcYlgHI=",
        version = "v2.52.1",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:ad0vkEBuk23VJzZR9nkLVG0YAoN9coASF1GusYX6AlU=",
        version = "v2.23.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:8DjSi4H/k+RqoOmwXkxW14A2H1pdPdS95+qmdJ4q1Tg=",
        version = "v4.13.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:IKsSdax3m7zsi4ooThn7YR74PMsx8fqcLcEeA6164nI=",
    ...
    go_repository(
        name = "com_github_oapi_codegen_echo_middleware",
        importpath = "github.com/oapi-codegen/echo-middleware",
        sum = "h1:oNBqiE7jd/9bfGNk/bpbX2nqWrtPc+LL4Boya8Wl81U=",
        version = "v1.0.2",
    )
    go_repository(
        name = "com_github_oapi_codegen_oapi_codegen_v2",
        importpath = "github.com/oapi-codegen/oapi-codegen/v2",
        sum = "h1:ykgG34472DWey7TSjd8vIfNykXgjOgYJZoQbKfEeY/Q=",
        version = "v2.4.1",
    )
    go_repository(
    ...
    go_repository(
        name = "com_github_speakeasy_api_openapi_overlay",
        importpath = "github.com/speakeasy-api/openapi-overlay",
        sum = "h1:Wrz6NO02cNlLzx1fB093lBlYxSI54VRhy1aSutx0PQg=",
        version = "v0.9.0",
    )
    go_repository(
    ...
    go_repository(
        name = "com_github_wolfeidau_echo_middleware",
        importpath = "github.com/wolfeidau/echo-middleware",
        sum = "h1:iG/mm/90eL6wKuepFVIoP8lfLO99Qwy4bTV8P3DybNE=",
        version = "v1.6.2",
    )
    go_repository(
        name = "com_github_wolfeidau_lambda_go_extras",
        importpath = "github.com/wolfeidau/lambda-go-extras",
        sum = "h1:y3TCwHZiLeCmL+kq8cLgjCw0CXNzFhzp0Phfz3N2OfY=",
        version = "v1.5.1",
    )
    go_repository(
        name = "com_github_wolfeidau_lambda_go_extras_middleware_raw",
        importpath = "github.com/wolfeidau/lambda-go-extras/middleware/raw",
        sum = "h1:xsPoHOLzRuwQjk0Jgk7Y00E1NW5DS9YvyuV8cD757SE=",
        version = "v1.5.1",
    )
    go_repository(
        name = "com_github_wolfeidau_lambda_go_extras_middleware_zerolog",
        importpath = "github.com/wolfeidau/lambda-go-extras/middleware/zerolog",
        sum = "h1:NvkOh9EFStNics07b96Oz252sWWffLqykHcg1bpo7wg=",
        version = "v1.5.1",
    )
    go_repository(
