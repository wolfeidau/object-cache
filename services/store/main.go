...
import (
	...
	"github.com/wolfeidau/object-cache/services/store/internal/commands"
)
...
func main() {
	...
	tp, err := trace.NewProvider(ctx, "github.com/wolfeidau/object-cache/services/store", version)
	if err != nil {
